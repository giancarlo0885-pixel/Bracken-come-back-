...
REPAIR_STATEMENTS = [
    ...
    "ALTER TABLE trade_dna ADD COLUMN IF NOT EXISTS entry_decision_id TEXT",
    "ALTER TABLE trade_dna ADD COLUMN IF NOT EXISTS entry_signal_id TEXT",
    "ALTER TABLE trade_dna ADD COLUMN IF NOT EXISTS entry_forecast_id TEXT",
    "ALTER TABLE trade_dna ADD COLUMN IF NOT EXISTS entry_quote_id TEXT",
    "ALTER TABLE trade_dna ADD COLUMN IF NOT EXISTS decision_correlation_id TEXT",
...
POST_MIGRATION_MAINTENANCE = [
    ...
    "ALTER TABLE oracle_decision_replays SET (autovacuum_vacuum_scale_factor = 0.01, autovacuum_vacuum_threshold = 50, autovacuum_analyze_scale_factor = 0.02, autovacuum_analyze_threshold = 50)",
    "ALTER TABLE forecast_validation SET (autovacuum_vacuum_scale_factor = 0.015, autovacuum_vacuum_threshold = 75, autovacuum_analyze_scale_factor = 0.02, autovacuum_analyze_threshold = 75)",
]
