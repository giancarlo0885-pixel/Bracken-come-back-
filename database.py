...
DATABASE_RETENTION_POLICIES = {
    ...
    "recommendations": {"keep_rows": 12000, "batch_size": DATABASE_RETENTION_BATCH_SIZE, "classification": "append-only analytical/ephemeral"},
    "recommendation_evidence": {"keep_rows": 24000, "batch_size": DATABASE_RETENTION_BATCH_SIZE, "classification": "append-only analytical/ephemeral"},
    "strategy_signals": {"keep_rows": 12000, "batch_size": DATABASE_RETENTION_BATCH_SIZE, "classification": "append-only analytical/ephemeral"},
    "forecast_results": {"keep_rows": 12000, "batch_size": DATABASE_RETENTION_BATCH_SIZE, "classification": "append-only analytical/ephemeral"},
}
DATABASE_TABLE_GROWTH_AUDIT = {
    ...
    "recommendations": {"class": "append-only analytical/ephemeral records", "inserted_by": "advisor recommendations", "frequency": "advisor generation", "retention": "keep newest 12000 rows"},
    "recommendation_evidence": {"class": "append-only analytical/ephemeral records", "inserted_by": "advisor evidence persistence", "frequency": "per recommendation", "retention": "keep newest 24000 rows"},
    "strategy_signals": {"class": "append-only analytical/ephemeral records", "inserted_by": "strategy engine", "frequency": "strategy evaluation", "retention": "keep newest 12000 rows"},
    "forecast_results": {"class": "append-only analytical/ephemeral records", "inserted_by": "forecasting registry", "frequency": "forecast generation", "retention": "keep newest 12000 rows"},
