...
STOCK_ALWAYS_INVESTED=true
STOCK_MIN_CASH_RESERVE_PCT=0.15
STOCK_CORE_TARGET_PCT=0.30
STOCK_TACTICAL_MAX_PCT=0.55
STOCK_CORE_SPY_WEIGHT=0.45
STOCK_CORE_QQQ_WEIGHT=0.35
STOCK_CORE_IWM_WEIGHT=0.10
STOCK_CORE_DIA_WEIGHT=0.10
MAX_STOCK_TACTICAL_POSITIONS=8
MAX_STOCK_SECTOR_EXPOSURE_PCT=0.30
MIN_STOCK_PRICE=3.00
MIN_AVG_DOLLAR_VOLUME=20000000
MIN_AVG_VOLUME=500000
MAX_STOCK_SPREAD_PCT=0.015
STOCK_ROTATION_MIN_SCORE_IMPROVEMENT=8
MAX_ENTRY_EXTENSION_FROM_VWAP_PCT=0.06
MAX_SINGLE_BAR_SPIKE_PCT=0.08
ENABLE_STOCK_REGULAR_HOURS=true
ENABLE_STOCK_EXTENDED_HOURS=true
