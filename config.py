...
SUPER_HYBRID_MIN_SOURCE_DIVERSITY = max(0.0, min(100.0, float(os.getenv("SUPER_HYBRID_MIN_SOURCE_DIVERSITY", "55.0"))))
SUPER_HYBRID_MIN_COST_ADJUSTED_CONVICTION = max(0.0, min(100.0, float(os.getenv("SUPER_HYBRID_MIN_COST_ADJUSTED_CONVICTION", "50.0"))))
SUPER_HYBRID_MIN_ADVERSARIAL_MARGIN = max(-100.0, min(100.0, float(os.getenv("SUPER_HYBRID_MIN_ADVERSARIAL_MARGIN", "0.0"))))
